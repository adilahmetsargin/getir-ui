                 ...
                 <div className='flex gap-x-2'>
                    <ReactFlagsSelect
                      ...
                      <label className='flex-1 relative group cursor-pointer block'>
                        ...
                        <span className='absolute top-0 left-0 flex items-center h-full px-4 text-sm text-gray-700 transition-all peer-focus:h-7 peer-focus:text-primary-brand-color peer-focus:text-xs peer-valid:h-7 peer-valid:text-primary-brand-color peer-valid:text-xs'>Telefon Numarası</span>
                      </label>
                  </div>
